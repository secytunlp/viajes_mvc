 ...
 * @since 10/06/2105
 */
class ViewCambioPDF extends CdtPDFPrint{
	...
	function printCambio(  ){
		...
		$this->Ambitos();
		if ($this->getPeriodo_oid()>intval(CYT_ESTADO_SOLICITUD_PERIODO_2011)) {
			if($this->getPeriodo_oid()==intval(CYT_ESTADO_SOLICITUD_PERIODO_2012)) {
