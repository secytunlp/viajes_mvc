...
(function($){
	$.fn.extend(
	{
		simpleAutoComplete: function( page, options, callback )
		{
			...
			{
				alert("simpleAutoComplete: Debe especificar la p&aacute;gina de consulta.");
			}
			...
			thisElement.keyup(function( ev )
			{
				...
				if( typeof(options) == "object" )
				{
					...
					attrLabel = typeof( options.attrLabel ) != "undefined" ? options.attrLabel : attrLabel;
					//attrLabel = "holaaaaaaaa";
